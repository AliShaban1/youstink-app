  ...
  return (
    ...
    >
      <div className="pg">
          ...
          {step >= 1 && step <= 3 && (
            <div className="pills">
              {[1, 2, 3].map((s) => (
                <div
                  key={s}
                  className={`pill ${step === s ? "a" : step > s ? "d" : ""}`}
                />
              ))}
            </div>
          )}
          ...
          <div className={animate ? "fi" : ""}>
            ...
            <div className="stats">
              <div style={{ textAlign: "center" }}>
                <div className="sn">4,209</div>
                <div className="sl">nudges sent</div>
              </div>
              <div style={{ textAlign: "center" }}>
                <div className="sn">100%</div>
                <div className="sl">anonymous</div>
              </div>
              <div style={{ textAlign: "center" }}>
                <div className="sn">0</div>
                <div className="sl">friendships lost</div>
              </div>
            </div>
          </div>
        )}
        ...
        {step === 1 && (
          <div className={animate ? "fi" : ""}>
            <button className="bl" onClick={() => go(0)}>
              ← Back
            </button>
            ...
            >
              <FunnyIcon />
              <div>
                <div className="vn">Funny</div>
                <div className="vd">
                  Roast them. They'll laugh... eventually.
                </div>
              </div>
            ...
            >
              <KindIcon />
              <div>
                <div className="vn">Kind</div>
                <div className="vd">
                  Gentle. "I'm saying this because I care."
                </div>
              </div>
              <span className="va">→</span>
            </button>
        ...
        {step === 3 && (
          <div className={animate ? "fi" : ""}>
            <button className="bl" onClick={() => go(2)}>
              ← Back
            </button>
            <h2 className="st">Their phone number.</h2>
            <p className="ss">
              We'll text them anonymously. Your info is never shared.
            </p>
        ...
        {step === 5 && (
          <div className={`dnc ${animate ? "fi" : ""}`}>
            ...
            <p className="dnb">
              The truth is on its way. Your identity is safe. You just did them
              a favor they'll never know to thank you for.
            </p>
      ...
      <style jsx>{`
        ...
        .tag {
          ...
          height: 22px;
          margin-bottom: 48px;
          animation: fadeTag 3.2s ease-in-out infinite;
        }
        .bp {
          width: 100%;
          padding: 18px 24px;
